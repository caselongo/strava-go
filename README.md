...
This library is a continuation of the archived library from Strava itself: https://github.com/strava/go.strava

Strava-go provides a complete wrapper library for the [Strava V3 API](http://strava.github.com/api).
...
#### To install
	...
	go get github.com/caselongo/strava-go
